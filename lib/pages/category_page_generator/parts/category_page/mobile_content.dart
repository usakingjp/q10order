...
class MobileContent extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final psModel = ref.watch(pageSettingM);
    final psModelNotifier = ref.read(pageSettingM.notifier);
    //リストかタイルか（スイッチ）
    ...
    final sampleWidth = useState(int.tryParse(psModel.sampleWidth) ?? 400);
          ...
          SettingRow(
            ...
            widget: OutlinedButton(
              ...
              onPressed: () async {
                ...
                await prefs.setInt('listOrTileM', listOrTile.value);
              },
            ),
          ),
          SettingRow(
            ...
            widget: (listOrTile.value == 0)
                ...
                : DropdownButton(
                    ...
                    onChanged: (v) async {
                      ...
                      final SharedPreferences prefs =
                          await SharedPreferences.getInstance();
                      await prefs.setInt('rowQtyM', v ?? 2);
                    }),
          ),
          SettingRow(
            label: 'アクセントカラー',
            widget: InkWell(
              ...
              onTap: () async {
                ...
                if (pickedColor != null) {
                  ...
                  final SharedPreferences prefs =
                      await SharedPreferences.getInstance();
                  await prefs.setInt('accentColorM', pickedColor.value);
                }
              },
            ),
          ),
            ...
            widget: InkWell(
              ...
              onTap: () async {
                ...
                if (pickedColor != null) {
                  ...
                  final SharedPreferences prefs =
                      await SharedPreferences.getInstance();
                  await prefs.setInt('subColorM', pickedColor.value);
                }
              },
            ),
          ),
            ...
            widget: Container(
              ...
              child: TextFormField(
                ...
                onTapOutside: (v) async {
                  ...
                  final SharedPreferences prefs =
                      await SharedPreferences.getInstance();
                  await prefs.setString('titleLengthM', titleLengthText.text);
                    ...
                    Container(
                        ...
                        child: TextFormField(
                          ...
                          onFieldSubmitted: (v) async {
                            ...
                            final SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            await prefs.setStringList('exclusionsM', copy);
                            exclusionText.text = '';
                          },
                        )),
                    OutlinedButton(
          ...
          SettingRow(
            ...
            widget: Wrap(
              ...
              children: [
                ...
                OriginalCheckBox(
                  label: 'ブランド名',
                  prefLabel: 'dispBrandM',
                  val: dispBrand,
                ),
                OriginalCheckBox(
                  label: '広告文',
                  prefLabel: 'dispPromotionM',
                  val: dispPromotion,
                ),
                OriginalCheckBox(
                  label: '画像',
                  prefLabel: 'dispImageM',
                  val: dispImage,
                ),
                OriginalCheckBox(
                  label: '価格',
                  prefLabel: 'dispPriceM',
                  val: dispPrice,
                ),
              ],
            ),
            ...
            widget: Container(
              ...
              child: TextFormField(
                ...
                onChanged: (v) async {
                  if (int.parse(v) > 1080) {
                    v = '1080';
                    sampleWidthText.text = '1080';
                  }
                  if (int.parse(v) > 250) {
                    sampleWidth.value = int.parse(v);
                    final SharedPreferences prefs =
                        await SharedPreferences.getInstance();
                    await prefs.setString('sampleWidthM', v);
                  }
                },
              ),
            ),
